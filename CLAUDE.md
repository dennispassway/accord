...
Bestandsspecifieke regels staan in `.claude/rules/`, elk met een "Geldt voor"-regel
bovenaan: loop de map door en lees wat op jouw bestanden slaat voor je ze aanraakt.
